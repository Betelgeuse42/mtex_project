...
ebsd0 = loadEBSD('3_very small area.ang');
...
disp(name)
%% EBSD representation properties
ebsd0 = loadEBSD('3_small area.ang');
...
% ebsd1 - working data
% ebsd2 - modified working data
name = 'AK_1200_v300_50ds_920_V300_15ds';
%% First loading
% % Load EBSD data
%ebsd = loadEBSD('testEBSD001.ang');
% save('data0.mat', 'ebsd');
...
disp(name)
%% EBSD representation properties
ebsd0 = loadEBSD('AK_1200_v300_50ds_920_V300_15ds.ang');
...
disp(name)
%% EBSD representation properties
ebsd0 = loadEBSD('6_very small area.ang');
...
disp(name)
%% EBSD representation properties
ebsd0 = loadEBSD('2_very small area.ang');
